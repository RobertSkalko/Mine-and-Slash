...
public class Writer {
   ...
   *          The object that should be stored
   */
  public static <T> void write(@Nullable Set<NBTAction> phase, @Nullable CompoundNBT tag, T object) {
   ...
   *          The object that should be stored
   */
  public static <T> void write(Registry registry, NBTAction phase, @Nullable CompoundNBT tag, T object) {
   ...
   *          The object that should be stored
   */
  public static <T> void write(NBTAction phase, @Nullable CompoundNBT tag, T object) {
   ...
   *          The object that should be stored
   */
  public static <T> void write(Registry registry, @Nullable CompoundNBT tag, T object) {
   ...
   *          The object that should be stored
   */
  public static <T> void write(@Nullable CompoundNBT tag, T object) {
   ...
   */
  public static <T> void writeField(@Nullable CompoundNBT tag, @Nullable Type fieldType, @Nullable String fieldName, @Nullable T object) {
    try {
