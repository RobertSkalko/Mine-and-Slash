...
public class StorableEngine {
    ...
    <T> T getSingleField(Registry registry, Set<NBTAction> phase, CompoundNBT tag,
                         String fieldName, Type type,
                         @Nullable T object) throws InstantiationException, IllegalAccessException, IllegalArgumentException, NoHandlerFoundException {
    ...
    public static <T> void setSingleField(Registry registry, Set<NBTAction> phase,
                                          ...
                                          Type fieldType,
                                          @Nullable T fieldData) throws InstantiationException, IllegalAccessException, IllegalArgumentException, NoHandlerFoundException {
        if (fieldData != null) {
