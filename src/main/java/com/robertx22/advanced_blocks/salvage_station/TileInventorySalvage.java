...
public class TileInventorySalvage extends TileEntity implements IInventory, ITickable {
	...
	public static ItemStack getSmeltingResultForItem(ItemStack stack) {
		...
		if (gear != null) {
			...
			ItemOre ore = (ItemOre) RandomUtils.WeightedRandom(ListUtils.CollectionToList(ItemOre.ItemOres.values()));
