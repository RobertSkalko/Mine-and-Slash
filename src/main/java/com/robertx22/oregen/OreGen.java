...
public class OreGen implements IWorldGenerator {
    ...
    public OreGen(Block blockToGen, int blockCount, int minHeight, int maxHeight, int spawnChance, int
            dimension) {
    ...
    private void runGenerator(WorldGenerator generator, World world, Random rand, int chunk_X, int chunk_Z, int
            chancesToSpawn, int minHeight, int maxHeight) {
