...
public interface IProxy {
  ...
  default void registerRenders() {
    ...
    RegisterModEntity(Items.GLOWSTONE_DUST, SpellLightningExplosion.EntityLightningExplosion.class,
        i++);
  ...
  /**
   * Fml life cycle event for Pre-Initialization. Historically (before registry events) this was
   * where blocks, items, etc. were registered. There are still things like entities and networking
   * which should still be registered here.
   *
  ...
  /**
   * Fml life cycle event Post Initialization. This phase is useful For doing inter-mod stuff like
   * checking which mods are loaded or if you want a complete view of things across mods like having
  ...
  void setShieldRenderer(NormalShield normalShield);
