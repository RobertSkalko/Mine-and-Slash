...
import com.robertx22.testing.TestManager;
...
public class Main {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		CapabilityManager.INSTANCE.register(EntityData.IData.class, new EntityData.Storage(), EntityData.DefaultImpl.class);
		
		CapabilityManager.INSTANCE.register(StackData.IData.class, new StackData.Storage(), StackData.IData.class);
