...
public class Main {
	...
	/*
	 * modMeta.name = Ref.NAME; modMeta.version = Ref.VERSION; modMeta.authorList =
	 * Arrays.asList("robertx22"); modMeta.autogenerated = false;
	 * modMeta.description = Ref.DESC; modMeta.url =
	 * "https://minecraft.curseforge.com/projects/mine-and-slash-reloaded";
	 */
