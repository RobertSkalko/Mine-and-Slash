...
public class NonWeaponSuffixes implements ISlashRegistryInit {
    ...
    public void registerAll() {
        ...
        ElementalAffixBuilder.start()
            ...
            .tier(1, x -> Arrays.asList(new StatModifier(40, 50, new ElementalResist(x), ModType.FLAT)))
            .tier(2, x -> Arrays.asList(new StatModifier(25, 40, new ElementalResist(x), ModType.FLAT)))
            .tier(3, x -> Arrays.asList(new StatModifier(12, 25, new ElementalResist(x), ModType.FLAT)))
            ...
            .Req(SlotRequirement.everthingBesides(GearItemSlot.SlotFamily.Weapon))
            .Suffix()
            .Build();
    }
}