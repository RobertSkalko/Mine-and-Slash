...
public class OrbOfBlessingItem extends CurrencyItem implements ICurrencyItemEffect, IRenamed, IHasRecipe {
    @Override
    public String GUID() {
    ...
    public BaseRecipe getRecipe() {
        return SimpleRecipe.Builder.create(GUID(), Professions.TINKERERING)
            ...
            .addMaterial(new CrystalOfLegendItem().getFromForgeRegistry(), 2)
