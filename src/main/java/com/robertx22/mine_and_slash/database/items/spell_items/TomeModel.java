...
public class TomeModel extends Model {
    private final ModelRenderer field_78102_a = (new ModelRenderer(64, 32, 0, 0)).addCuboid(-6.0F, -5.0F, -0.005F, 6.0F, 10.0F, 0.005F);
    private final ModelRenderer field_78100_b = (new ModelRenderer(64, 32, 16, 0)).addCuboid(0.0F, -5.0F, -0.005F, 6.0F, 10.0F, 0.005F);
    private final ModelRenderer field_78101_c = (new ModelRenderer(64, 32, 0, 10)).addCuboid(0.0F, -4.0F, -0.99F, 5.0F, 8.0F, 1.0F);
    private final ModelRenderer field_78098_d = (new ModelRenderer(64, 32, 12, 10)).addCuboid(0.0F, -4.0F, -0.01F, 5.0F, 8.0F, 1.0F);
    private final ModelRenderer field_78099_e = (new ModelRenderer(64, 32, 24, 10)).addCuboid(0.0F, -4.0F, 0.0F, 5.0F, 8.0F, 0.005F);
    private final ModelRenderer field_78096_f = (new ModelRenderer(64, 32, 24, 10)).addCuboid(0.0F, -4.0F, 0.0F, 5.0F, 8.0F, 0.005F);
    private final ModelRenderer field_78097_g = (new ModelRenderer(64, 32, 12, 0)).addCuboid(-1.0F, -5.0F, 0.0F, 2.0F, 10.0F, 0.005F);
    private final List<ModelRenderer> parts;

    public TomeModel() {
        super(RenderType::getEntitySolid);
        this.parts = ImmutableList.of(this.field_78102_a, this.field_78100_b, this.field_78097_g, this.field_78101_c, this.field_78098_d, this.field_78099_e, this.field_78096_f);
    ...
    public void render(MatrixStack p_225598_1_, IVertexBuilder p_225598_2_,
    ...
    public void setPageAngles(float p_228247_1_, float p_228247_2_, float p_228247_3_,
                              float p_228247_4_) {
