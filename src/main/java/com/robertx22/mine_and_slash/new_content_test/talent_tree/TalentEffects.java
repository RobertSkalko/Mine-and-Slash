...
public class TalentEffects {
    ...
    public static TalentPointEffect MAJOR_INT = new TalentPointEffect(new ExactStatData(10, StatTypes.Flat, Intelligence.GUID))
            .type(PerkType.MAJOR);

    public static TalentPointEffect BIG_INT = new TalentPointEffect(new ExactStatData(5, StatTypes.Flat, Intelligence.GUID))
            .type(PerkType.BIG);
