...
public enum Elements implements IColor {
    Physical(0, new RGB(240, 157, 55), false, "Physical", TextFormatting.GOLD, Items.COAL, "physical", "\u2726"),
    Fire(1, new RGB(255, 0, 0), true, "Fire", TextFormatting.RED, Items.FIRE_CHARGE, "fire",
        "\u2600"
    ),
    Water(2, new RGB(0, 128, 255), true, "Ice", TextFormatting.AQUA, Items.SNOWBALL, "water", "\u2749"
    ),
    Thunder(3, new RGB(204, 0, 255), true, "Lightning", TextFormatting.YELLOW, Items.GLOWSTONE_DUST,
        "thunder", "\u272A"),
    Nature(4, new RGB(0, 204, 0), true, "Poison", TextFormatting.DARK_GREEN, Items.SLIME_BALL, "nature", "\u273F"),
    Elemental(5, new RGB(0, 0, 0), false, "Elemental", TextFormatting.GOLD, Items.EMERALD, "elemental", "\u269C"
    );
