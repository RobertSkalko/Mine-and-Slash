...
public enum AdvDescs implements IAutoLocName {
    ...
    AutoSalvageBag(
            "These bags when equipped will automatically salvage items! This means all those bad common, uncommon " +
                    "and" + " other useless items can be automatically salvaged! Higher rarity bag gives more bonus " +
                    "item " + "chance."),
    ...
    Stoneofhope(
            "Recreates the item completely, giving you a higher rarity. Very useful if you have a legendary item " +
                    "with" + " bad/unwanted stats. This item can only be gotten by using the map device to go kill " +
                    "mobs in " + "adventure maps above tier " + new ItemStoneOfHope()
                    .Tier()),
