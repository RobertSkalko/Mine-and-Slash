...
public class MyAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consu) {
        ...
        Advancement legendaryMob = mobRarityKill(Rarities.Mobs.get(IRarity.Legendary),
                                                 AdvDescs.MobRaritySpawnAt.locName().appendText("10"), parent, consu,
                                                 Items.ZOMBIE_HEAD
        );
        Advancement mythicMob = mobRarityKill(Rarities.Mobs.get(IRarity.Mythic),
                                              AdvDescs.MobRaritySpawnAt.locName().appendText("20"), legendaryMob, consu,
                                              Items.CREEPER_HEAD
        );
        ...
        SlashRegistry.Bosses().getList().forEach(x -> bossKill(x, bossMob, consu));
        ...
        Advancement map_device = itemAdv(AdvTitles.MapDevice, AdvDescs.MapDevice, "map_device", first_adv_map, consu,
                                         BlockRegister.BLOCK_MAP_DEVICE
        );
    ...
    private Advancement levelAdv(int lvl, AdvDescs desc, Advancement parent, Consumer<Advancement> consumerAdv,
        ...
        Advancement adv = Advancement.Builder.builder()
                .withParent(parent)
                .withDisplay(item, Words.Level.locName().appendText(": " + lvl), desc.locName(), null,
    ...
    private Advancement mobRarityKill(MobRarity rar, ITextComponent desc, Advancement parent,
        ...
        Advancement adv = Advancement.Builder.builder()
                .withParent(parent)
                .withDisplay(item, Words.Kill.locName().appendText(": ").appendSibling(rar.locName()), desc, null,
                             FrameType.CHALLENGE, true, true, false
                )
    ...
    private Advancement bossKill(Boss boss, Advancement parent, Consumer<Advancement> consumerAdv) {
        ...
        Advancement adv = Advancement.Builder.builder()
                .withParent(parent)
                .withDisplay(Items.DRAGON_HEAD, Words.KillBoss.locName().appendText(" ").appendSibling(boss.getName()),
