...
public class ModEntityConfigs implements ISlashRegistryInit {
    ...
    public ModEntityConfigs() {
        ...
        byEntityTypeDefault.put(EntityTypeUtils.EntityType.MOB, new ModEntityConfig(1));
        byEntityTypeDefault.put(EntityTypeUtils.EntityType.ANIMAL, new ModEntityConfig(0.01F));
        byEntityTypeDefault.put(EntityTypeUtils.EntityType.NPC, new ModEntityConfig(0.05F));
        byEntityTypeDefault.put(EntityTypeUtils.EntityType.OTHER, new ModEntityConfig(0));
        byEntityTypeDefault.put(EntityTypeUtils.EntityType.PLAYER, new ModEntityConfig(0));
    ...
    public void registerAll() {
        specificMobs.entrySet()
            .forEach(x -> x.getValue().GUID = x.getKey());
        allMobsInAMod.entrySet()
            .forEach(x -> x.getValue().GUID = x.getKey());
        specificMobs.entrySet()
