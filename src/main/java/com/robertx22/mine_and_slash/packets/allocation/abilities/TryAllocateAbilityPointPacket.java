...
public class TryAllocateAbilityPointPacket {
    ...
    public TryAllocateAbilityPointPacket(IAbility perk) {
        this.guid = perk.GUID();
    }

    public static TryAllocateAbilityPointPacket decode(PacketBuffer buf) {

        TryAllocateAbilityPointPacket newpkt = new TryAllocateAbilityPointPacket();
    ...
    public static void encode(TryAllocateAbilityPointPacket packet, PacketBuffer tag) {
        tag.writeString(packet.guid, 50);
    }

    public static void handle(final TryAllocateAbilityPointPacket pkt, Supplier<NetworkEvent.Context> ctx) {
