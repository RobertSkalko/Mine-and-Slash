...
public class OpenGuiWrapper {
    ...
    public static void openStatAllocation() {
        DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> {
            net.minecraft.client.Minecraft.getInstance().displayGuiScreen(new StatAllocationScreen());
        });
    }
    ...
    public static void openTalents() {
        DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> {
            net.minecraft.client.Minecraft.getInstance().displayGuiScreen(new TalentPerkTreeScreen());
        });
    }
}
