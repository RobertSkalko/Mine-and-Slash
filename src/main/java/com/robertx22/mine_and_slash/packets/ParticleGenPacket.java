...
public class ParticleGenPacket {
    ...
    public ParticleGenPacket(String name, double x, double y, double z, double xVel, double yVel, double zVel,
                             double radius, int amount, IColor icolor) {
    ...
    public static void handle(final ParticleGenPacket message, Supplier<NetworkEvent.Context> ctx) {
