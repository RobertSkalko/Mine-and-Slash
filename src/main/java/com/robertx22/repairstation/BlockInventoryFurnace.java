...
public class BlockInventoryFurnace extends BlockContainer {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerIn.openGui(Main.instance, GuiHandlerMBE31.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		if (burningSides == 0) {
			...
			lightValue = ONE_SIDE_LIGHT_VALUE
					+ (int) ((FOUR_SIDE_LIGHT_VALUE - ONE_SIDE_LIGHT_VALUE) / (4.0 - 1.0) * burningSides);
		}
