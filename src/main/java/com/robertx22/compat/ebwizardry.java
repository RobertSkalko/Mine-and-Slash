...
public class ebwizardry {
	...
	private static final List<String> STAFF = ImmutableList.of("magic_wand", "apprentice_wand", "advanced_wand",
			"master_wand", "novice_fire_wand", "novice_ice_wand", "novice_lightning_wand", "novice_necromancy_wand",
			...
			"apprentice_sorcery_wand", "apprentice_healing_wand", "advanced_earth_wand", "advanced_sorcery_wand",
			"advanced_healing_wand", "advanced_fire_wand", "advanced_ice_wand", "advanced_lightning_wand",
			"advanced_necromancy_wand", "advanced_earth_wand", "advanced_sorcery_wand", "advanced_healing_wand",
			"master_earth_wand", "master_sorcery_wand", "master_healing_wand", "master_fire_wand", "master_ice_wand",
			"master_lightning_wand", "master_necromancy_wand", "master_earth_wand", "master_sorcery_wand",
			"master_healing_wand");

	private static final List<String> Helmet = ImmutableList.of("wizard_hat", "wizard_hat_fire", "wizard_hat_ice",
			"wizard_hat_lightning", "wizard_hat_necromancy", "wizard_hat_earth", "wizard_hat_sorcery",
			"wizard_hat_healing");

	private static final List<String> Chestplate = ImmutableList.of("wizard_robe", "wizard_robe_fire",
			"wizard_robe_ice", "wizard_robe_lightning", "wizard_robe_necromancy", "wizard_robe_earth",
			"wizard_robe_sorcery", "wizard_robe_healing");

	private static final List<String> Leggings = ImmutableList.of("wizard_leggings", "wizard_leggings_fire",
			"wizard_leggings_ice", "wizard_leggings_lightning", "wizard_leggings_necromancy", "wizard_leggings_earth",
			"wizard_leggings_sorcery", "wizard_leggings_healing");

	private static final List<String> Boots = ImmutableList.of("wizard_boots", "wizard_boots_fire", "wizard_boots_ice",
	...
	public ebwizardry() {
		...
		for (String s : STAFF) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Staff()));
			LOGGER.debug("Registered Staffs");
		}
		for (String s : Helmet) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Helmet()));
		...
		for (String s : Leggings) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Pants()));
			LOGGER.debug("Registered Leggings");
		}
		for (String s : Boots) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Boots()));
			LOGGER.debug("Registered Boots");
		}
		for (String s : Ring) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Ring()));
			LOGGER.debug("Registered Rings");
		}
		for (String s : Amulet) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Necklace()));
			LOGGER.debug("Registered Amulets");
		}
		for (String s : Charm) {
			MineAndSlashAPI.addCompatibleItem("ebwizardry:" + s, new ConfigItem().setType(new Charm()));
