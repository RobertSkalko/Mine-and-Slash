...
public class RenderTileMapPortal extends TileEntitySpecialRenderer<TileMapPortal> {
	...
	public void render(TileMapPortal te, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {
